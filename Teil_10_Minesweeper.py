...
bild_normal = ladeBild('ms_cell_normal.gif')
bild_markiert = ladeBild('ms_cell_marked.gif')
bild_mine = ladeBild('ms_cell_mine.gif')
bild_aufgedeckt = []
for n in range(9):
  bild_aufgedeckt.append(ladeBild(f'ms_cell_{n}.gif'))
